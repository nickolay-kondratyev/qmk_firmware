 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt | _LH_L1| /Space  /       \Enter \  |_RH_L1| LAlt | LGUI |
 *                   |      |      |       |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
// ---------------------------------------------------------------------------------------------------------------
/*
 * _RH_L1: Right hand Level 1
 * Right hand Activated by RIGHT HAND side activation
 *
...
[_RH_L1] = LAYOUT(
  ...
  KC_LSFT, C3MC_Z,  C3MC_X, C3MC_C,  C3MC_V,  C3MC_B, KC_TRNS,  KC_TRNS, MSO_N, MSO_M, MSO_TL, MSO_TR, MSO_SF, KC_LSFT,
                       KC_LGUI, KC_LALT, KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_TRNS, MO(_RH_L2), KC_TRNS
),


/* _RH_L2: Right hand Level 2
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |KC_F14|   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  |  -   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |KC_F15|KC_F16|KC_F17|KC_F18|   G  |-------.    ,-------|   H  |   J  |   K  |   L  |   ;  |LCTRL |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |LShift|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |LShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt |       | /Space  /       \Enter \  |      | LAlt | LGUI |
 *                   |      |      |       |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_RH_L2] = LAYOUT(
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
  KC_TAB,   KC_Q, KC_F14,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS,
  KC_LCTL,KC_F15, KC_F16,  KC_F17,  KC_F18,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_LCTL,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
                      KC_LGUI, KC_LALT, KC_NO, KC_SPC,        KC_ENT, KC_NO, KC_LALT, KC_LGUI
),
        ...
        if (keycode >= CUSTOM_STRING_BASE && keycode < CUSTOM_STRING_BASE + num_custom_strings) {
         ...
         switch (keycode) {
            ...
            case O_MNDN:
             ...
             case KTTEST:
                  send_string("fun test(expected:){" SS_TAP(X_ENT) "val actual = " SS_TAP(X_ENT) "if (actual != expected){" SS_TAP(X_ENT) SS_TAP(X_TAB) "throw AssertionError(\"INPUT: [TODO], expected: [$expected], actual: [$actual]\")" SS_TAP(X_ENT) SS_LSFT(SS_TAP(X_TAB)) "}");
                  return false;
            case KT_EXC:
           ...
           case C3MC_H:
            ...
            case MSO_H:
                ...
                return false;
            case MSO_J:
                send_2_mod_shift_option(KC_J);
                return false;
            case MSO_K:
                send_2_mod_shift_option(KC_K);
                return false;
            case MSO_N:
